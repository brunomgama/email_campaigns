...
import { campaignsApi, type CreateCampaignRequest } from "@/lib/campaigns-api"
...
export function AddCampaignModal({ isOpen, onCloseAction, onCampaignAddedAction }: AddCampaignModalProps) {
  ...
  const validateForm = (): boolean => {
    ...
    // No field is mandatory since campaign can be created with fields missing
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await campaignsApi.create(requestData)
      toast.success("Campaign created successfully!")
      onCampaignAddedAction()
      onCloseAction()
    } catch (err) {
        ...
        <div className="flex items-center justify-between p-6 border-b">
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-1">
              Create a new email campaign. All fields are optional.
            </p>
          </div>
          <Button
            variant="ghost"
